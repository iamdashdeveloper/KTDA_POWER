...
const DefaultLoader: React.FC<DefaultLoaderProps> = ({
  ...
  return (
    <div
      className={`scale-0.3 inline-flex transform items-center justify-center ${className}`}
    >
      <svg
        viewBox={`0 0 ${viewBoxSize} ${viewBoxSize}`}
        className="m-2 h-50 w-50 transform-gpu overflow-visible p-2 md:h-60 md:w-60"
